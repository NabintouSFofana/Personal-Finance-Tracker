/*
 * Personal Finance Tracker · Nabintou S. Fofana · 2025
 * MIT-licensed code · https://github.com/NabintouSFofana/Personal-Finance-Tracker
 */
...
/**
 * Console version of the Personal Finance Tracker.
 *
 * <p>Kept alongside the GUI version so the same {@link Account} and
 * {@link Transaction} classes can be exercised without Swing. Useful for
 * scripting, learning, and writing tests against the model.
 *
 * <p>For the polished UI, run {@link FinanceTrackerGUI} instead.
 */
public class Main {
